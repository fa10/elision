...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <meta name="author" content="Elision">
    ...
    <body class="appear-animate">
        ...
        <div class="page" id="top">
            ...
            <!-- Home Section -->
            <section class="home-section bg-dark-alfa-90 parallax-7" data-background="images/full-width-images/section-bg-9.jpg" id="home">
                        ...
                        <div class="home-text">
                            <div class="container animate-init" data-anim-type="fade-in-up-big" data-anim-delay="100">
                                ...
                                <div class="hs-line-10">
                                    Branding   <span>/</span>   Design   <span>/</span>   Development   <span>/</span>   Photo
                                </div>
            ...
            <div class="google-map">
                <div data-address="Belt Parkway, Queens, NY, United States" data-color="#000000" id="map-canvas"></div>
            </div>
            <!-- End Google Map -->
